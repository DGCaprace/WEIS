...
class FASTLoadCases(ExplicitComponent):
    ...
    def update_FAST_model(self, fst_vt, inputs, discrete_inputs):
        ...
        if not 'YawSpr' in fst_vt['ServoDyn']: #prevent overwriting user input
            ...
            print("You specified YawSpr in ServoDyn. I won't overwrite it.")
        if not 'YawDamp' in fst_vt['ServoDyn']: #prevent overwriting user input
            ...
            print("You specified YawDamp in ServoDyn. I won't overwrite it.")
    ...
    def output_channels(self,fst_vt):
        ...
        channels_out += ["Spn1RDzb1", "Spn2RDzb1", "Spn3RDzb1", "Spn4RDzb1", "Spn5RDzb1", "Spn6RDzb1", "Spn7RDzb1", "Spn8RDzb1", "Spn9RDzb1"]
        channels_out += ["Spn1TDxb1", "Spn2TDxb1", "Spn3TDxb1", "Spn4TDxb1", "Spn5TDxb1", "Spn6TDxb1", "Spn7TDxb1", "Spn8TDxb1", "Spn9TDxb1"]
        channels_out += ["Spn1TDyb1", "Spn2TDyb1", "Spn3TDyb1", "Spn4TDyb1", "Spn5TDyb1", "Spn6TDyb1", "Spn7TDyb1", "Spn8TDyb1", "Spn9TDyb1"]
