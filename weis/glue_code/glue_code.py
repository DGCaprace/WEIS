        ...
        if modeling_options['ROSCO']['flag']:
            ...
            if not modeling_options['Level3']['from_openfast']:     #from WISDEM models
                ...
                if modeling_options["flags"]["tower"]:
                    ...
                    print("WARNING: no tower. Will assume tower grid height = hub height.")
                    self.connect("high_level_tower_props.hub_height",             'sse_tune.tune_rosco.TowerHt')
        ...
        if modeling_options['Level3']['flag'] or modeling_options['Level2']['flag']:
            ...
            if not modeling_options['Level3']['from_openfast']:
                ...
                if modeling_options["flags"]["tower"]:
                    ...
                    print("WARNING: no tower. Will connect hub height to what I can.")
                    self.connect("high_level_tower_props.hub_height",    'aeroelastic.tower_height')
                ...
                self.connect('rotorse.xu_spar', 'aeroelastic.beam:xu_spar')
                ...
                # For fatigue
                #DG: this is new stuff. Check how this works.
